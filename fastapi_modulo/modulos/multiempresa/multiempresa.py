...
from fastapi_modulo.modulos.multiempresa.me_models import EmpresaCreate, EmpresaUpdate
from fastapi_modulo.modulos.multiempresa.me_store import (
    create_empresa,
    delete_empresa,
    get_empresa,
    get_logo_path,
...
def multiempresa_page(request: Request):
    ...
    html_path = os.path.join(_MODULE_DIR, "multiempresa.html")
...
def multiempresa_js():
    js_path = os.path.join(_MODULE_DIR, "multiempresa.js")
