...
(function () {
  ...
  function renderCard(c, insc, pct) {
    ...
    return '<article class="cap-course-card">' +
      ...
      '<div class="cap-card-body">' +
        ...
        (c.descripcion ? '<p style="font-size:12px;color:#64748b;margin:0;line-clamp:2;-webkit-line-clamp:2;display:-webkit-box;-webkit-box-orient:vertical;overflow:hidden;">' + esc(c.descripcion) + '</p>' : '') +
      '</div>' +
  ...
  function renderGestionCursos() {
    ...
    var html = '<table class="cap-table"><thead><tr>' +
      '<th>Código</th><th>Nombre</th><th>Nivel</th><th>Estado</th><th>Inscritos</th><th></th>' +
      '</tr></thead><tbody>';
    list.forEach(function (c) {
      html += '<tr>' +
