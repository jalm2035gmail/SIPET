...
class CapCursoIn(CapCursoBase):
    pass


class CapCursoOut(CapCursoBase):
    id: int
...
class CapLeccionBase(BaseModel):
...
class CapLeccionIn(CapLeccionBase):
    curso_id: int


class CapLeccionOut(CapLeccionBase):
    id: int
    curso_id: int
    creado_en: Optional[datetime] = None
