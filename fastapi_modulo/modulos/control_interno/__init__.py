...
from fastapi_modulo.modulos.control_interno.control_interno_menu import MODULE_MENU, MENU_BY_KEY, get_menu_item
...
__all__ = ["MODULE_MENU", "MENU_BY_KEY", "get_menu_item", "router"]
