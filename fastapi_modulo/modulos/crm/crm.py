...
from fastapi_modulo.modulos.crm.crm_models import (
    ActividadCreate,
    ActividadUpdate,
    CampaniaCreate,
    CampaniaUpdate,
...
from fastapi_modulo.modulos.crm.crm_store import (
...
_CRM_TEMPLATE_PATH = os.path.join("fastapi_modulo", "modulos", "crm", "crm.html")
_CRM_JS_PATH = os.path.join("fastapi_modulo", "modulos", "crm", "crm.js")
