...
from fastapi_modulo.modulos.empleados.puestos_laborales_store import (
    delete_puesto,
    load_puestos,
    update_puesto_notebook,
    upsert_puesto,
)
from fastapi_modulo.modulos.empleados.departamentos_service import (
...
PUESTOS_LABORALES_TEMPLATE_PATH = os.path.join("fastapi_modulo", "modulos", "empleados", "puestos_laborales.html")
PUESTOS_LABORALES_JS_PATH = os.path.join("fastapi_modulo", "modulos", "empleados", "puestos_laborales.js")
PUESTOS_LABORALES_CSS_PATH = os.path.join("fastapi_modulo", "modulos", "empleados", "puestos_laborales.css")
