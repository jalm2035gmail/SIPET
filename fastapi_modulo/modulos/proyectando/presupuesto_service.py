...
CONTROL_MENSUAL_STORE_PATH = MODULE_DIR / "control_mensual_store.json"
LEGACY_CONTROL_MENSUAL_STORE_PATH = PROJECT_ROOT / "fastapi_modulo" / "modulos" / "presupuesto" / "control_mensual_store.json"
...
def _load_control_mensual_store() -> dict:
    source_path = CONTROL_MENSUAL_STORE_PATH if CONTROL_MENSUAL_STORE_PATH.exists() else LEGACY_CONTROL_MENSUAL_STORE_PATH
...
def proyectando_presupuesto_page(request: Request):
    ...
    template = request.app.state.templates.env.get_template("modulos/proyectando/presupuesto.html")
